...
export function setupRemoveButton(
  button,
  thaliElement
) {
  // Validation
  ...
  function handleClick() {
    if (thaliElement.lastChild) {
      thaliElement.removeChild(
        thaliElement.lastChild
      );
    }
  }
...
export function setupToggleItem(
  button,
  thaliElement,
  itemName
) {
...
export function createThaliManager(
  thaliElement,
  counterElement
) {
  // Validation
